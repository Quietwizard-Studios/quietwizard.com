...
"[project]/components/HUDBackground.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("line", {
                    ...
                    fileName: "[project]/components/HUDBackground.tsx",
                    lineNumber: 31,
                    columnNumber: 9
                }, this),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("line", {
                ...
                RINGS.map((ring, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("g", {
                        style: {
                        ...
                        children: [
                            ...
                            "tl" in ring && ring.ticks > 0 && ring.tl && Array.from({
                                length: ring.ticks
                            }, (_, j)=>{
...
function HUDBackground() {
    _s();
    const honeycombRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const hexgridRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const hudTimeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HUDBackground.useEffect": ()=>{
            // ── Honeycomb ──────────────────────────────────────────────
            ...
            function pointAtT(path, segs, total, t, w, h) {
                ...
                for(let i = 0; i < segs.length; i++){
                    if (dist + segs[i] >= target) {
                        ...
                        return {
                            x: (p0[0] + (p1[0] - p0[0]) * f) * w,
                            y: (p0[1] + (p1[1] - p0[1]) * f) * h
                        };
                    }
                    dist += segs[i];
                }
            ...
            const pulses = PATHS.map({
                "HUDBackground.useEffect.pulses": (path)=>({
                        path,
                        meta: calcMeta(path),
                        t: Math.random(),
                        speed: 0.00025 + Math.random() * 0.00015
                    })
            }["HUDBackground.useEffect.pulses"]);
            function buildGrid(w, h) {
                ...
                for(let i = 1; i <= rows; i++){
                    ...
                    oc.strokeStyle = `rgba(0,180,255,${a})`;
                    oc.lineWidth = 0.25 + t * 1.1;
                    oc.beginPath();
                    oc.moveTo(vx - halfW, y);
                    oc.lineTo(vx + halfW, y);
                    oc.stroke();
                }
                ...
                hGrad.addColorStop(0.5, "rgba(0,160,255,0.09)");
                hGrad.addColorStop(1, "transparent");
                oc.fillStyle = hGrad;
                oc.fillRect(0, vy - 40, w, 80);
            }
            let time = 0, animId;
            function drawHexgrid() {
                ...
                g1.addColorStop(0, `rgba(0,130,240,${0.045 * p})`);
                g1.addColorStop(0.45, `rgba(0,90,200,${0.02 * p})`);
                ...
                [
                    ...
                    "HUDBackground.useEffect.drawHexgrid": ([fx, fy, a])=>{
                        const g = hx.createRadialGradient(fx * W, fy * H, 0, fx * W, fy * H, gR * 0.42);
                        g.addColorStop(0, `rgba(0,70,180,${a * p})`);
                        g.addColorStop(1, "rgba(0,0,0,0)");
                        hx.fillStyle = g;
                        hx.fillRect(0, 0, W, H);
                    }
                }["HUDBackground.useEffect.drawHexgrid"]);
                pulses.forEach({
                    "HUDBackground.useEffect.drawHexgrid": (p2)=>{
                        hx.beginPath();
                        p2.path.forEach({
                            "HUDBackground.useEffect.drawHexgrid": ([fx, fy], i)=>{
                                if (i === 0) {
                                    hx.moveTo(fx * W, fy * H);
                                } else {
                                    hx.lineTo(fx * W, fy * H);
                        ...
                        hx.strokeStyle = "rgba(0,160,255,0.11)";
                        hx.lineWidth = 0.8;
                        hx.stroke();
                        ...
                        pg.addColorStop(0, "rgba(0,220,255,0.75)");
                        pg.addColorStop(1, "rgba(0,220,255,0)");
                        hx.beginPath();
                        hx.arc(pos.x, pos.y, 14, 0, Math.PI * 2);
                        hx.fillStyle = pg;
                        hx.fill();
                        hx.beginPath();
                        hx.arc(pos.x, pos.y, 2.5, 0, Math.PI * 2);
                        hx.fillStyle = "rgba(220,245,255,0.95)";
                        hx.fill();
                    }
                }["HUDBackground.useEffect.drawHexgrid"]);
            ...
            function resizeHexgrid() {
                W = hg.width = window.innerWidth;
                H = hg.height = window.innerHeight;
                buildGrid(W, H);
            }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ArcReactor, {}, void 0, false, {
                fileName: "[project]/components/HUDBackground.tsx",
                lineNumber: 350,
                columnNumber: 7
            }, this),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed top-0 left-0 w-[120px] h-[120px] pointer-events-none z-[3]",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HUDCorner, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed top-0 right-0 w-[120px] h-[120px] pointer-events-none z-[3]",
                style: {
                    transform: "scaleX(-1)"
                },
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HUDCorner, {
                    animation: "rotateArcR 8s linear infinite"
                }, void 0, false, {
                    fileName: "[project]/components/HUDBackground.tsx",
                    lineNumber: 366,
                    columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed bottom-0 left-0 w-[120px] h-[120px] pointer-events-none z-[3]",
                style: {
                    transform: "scaleY(-1)"
                },
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HUDCorner, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed bottom-0 right-0 w-[120px] h-[120px] pointer-events-none z-[3]",
                style: {
                    transform: "scale(-1)"
                },
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HUDCorner, {
                    animation: "rotateArcR 12s linear infinite"
                }, void 0, false, {
                    fileName: "[project]/components/HUDBackground.tsx",
                    lineNumber: 372,
                    columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    "BUILD: QWS-7.4.2 // STABLE",
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("br", {}, void 0, false, {
                        fileName: "[project]/components/HUDBackground.tsx",
                        lineNumber: 389,
                        columnNumber: 35
                    }, this),
                    "AGENT.POOL: 12 ONLINE",
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("br", {}, void 0, false, {
                        fileName: "[project]/components/HUDBackground.tsx",
                        lineNumber: 390,
                        columnNumber: 30
...
_s(HUDBackground, "mSjd/TrI0LDuLnytr9Nvyd8pyDo=");
_c2 = HUDBackground;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "ArcReactor");
__turbopack_context__.k.register(_c1, "HUDCorner");
__turbopack_context__.k.register(_c2, "HUDBackground");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/HUDBackground.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/components/HUDBackground.tsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=components_HUDBackground_tsx_0u-j1rs._.js.map